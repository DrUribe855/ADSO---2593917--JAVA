...
public class ListarProductos extends javax.swing.JFrame {
    ...
    public ListarProductos(Menu ventanaMenu, Producto [] listaProductos, int indexLista, String titulo) {
    ...
    public void imprimirClientes(){
        for(int i = 0; i < this.indexLista; i++){
            if(this.listaProductos[i] != null){
                etqTemporal = new JLabel(i + " " + this.listaProductos[i].getId()+ " - " + this.listaProductos[i].getNombre() + " - " + this.listaProductos[i].getPrecio() + " - " + this.listaProductos[i].getCantidad());
