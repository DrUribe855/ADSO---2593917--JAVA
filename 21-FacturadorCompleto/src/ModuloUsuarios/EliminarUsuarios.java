        ...
        if(cedula != ""){
            for(int i = 0; i < listaPersonas.length; i++){
                if(this.listaPersonas[i] != null){
                    if(listaPersonas[i].getCedula().equalsIgnoreCase(cedula) && listaPersonas[i+1] != null){
                    listaPersonas[i] = listaPersonas[i+1];
                    listaPersonas[i+1] = null;
            ...
            dispose();
            Alert alerta = new Alert("VALIDO","El usuario ha sido eliminado con exito","success");
        }
